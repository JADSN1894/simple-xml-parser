...
// Predicate function on the value if the parser succeeded,
// and only if that returns true do actually return a success,
// otherwise return as much of an error as a failed parse would.
